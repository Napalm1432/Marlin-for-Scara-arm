...
#define Linkage_1 162 // mm - Preprocessor cannot handle decimal points...
// Length of outer support arm
#define Linkage_2 162 // mm - Preprocessor cannot handle decimal points...
...
#define THETA_HOMING_OFFSET 10 // calculatated from Calibration Guide and command M360 / M114 see picture in http://reprap.harleystudio.co.za/?page_id=1073
#define PSI_HOMING_OFFSET 15   // calculatated from Calibration Guide and command M364 / M114 see picture in http://reprap.harleystudio.co.za/?page_id=1073
...
#define HOMING_FEEDRATE {60, 60, 60, 0}  // set the homing speeds (mm/min)

// default settings
// formula: ((steps per rev * stepping mode of motor)/360) * Gear Ratio
#define DEFAULT_AXIS_STEPS_PER_UNIT   {79,79,400,300}  // default steps per unit for SCARA
